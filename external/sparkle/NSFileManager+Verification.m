...
// Whitney Young (Reusable interface)
- (BOOL)validatePath:(NSString *)path withEncodedDSASignature:(NSString *)encodedSignature publicDSAKey:(NSString *)publicKey
{
	EVP_PKEY* pkey;
	if(!encodedSignature || !publicKey || !(pkey = load_dsa_key((char *)[publicKey UTF8String])))
		return NO;
