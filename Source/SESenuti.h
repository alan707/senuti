...
@class SEMenuController,
	SEInterfaceController,
	SELibraryController,
	SEUpdateController,
	SECopyController,
	SEAudioController,
	SEApplescriptController;

@interface SESenuti : NSObject {
	IBOutlet SEMenuController			*menuController;
	IBOutlet SEInterfaceController		*interfaceController;
	...
	BOOL controllersSetup, controllersTornDown;
}
