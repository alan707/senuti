...
@class SUDelegatedUpdater;
@protocol SEUpdateControllerStartStopObserverProtocol;
@interface SEUpdateController : SEObject <SEController> {
	SUDelegatedUpdater *updater;
