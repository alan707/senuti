...
#define LIBDIR "/usr/local/share/lib"
#define LOCALE_ALIAS_PATH LOCALEDIR

#if MAC_OS_X_VERSION_MIN_REQUIRED == MAC_OS_X_VERSION_10_4
	/* gettext does somethings which angers gcc 4.0.  I'm not sure how to check for 4.0, so we'll just check for the
	 * deployment target. #define STATIC makes it not use static in the problem spots.
	 */
	#define STATIC
#endif
