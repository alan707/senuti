...
|
|  $Id: itdb_itunesdb.c 1722 2007-10-07 11:33:30Z teuf $
*/
...
gboolean playcounts_init (FImport *fimp)
{
...
void itdb_free_fimp (FImport *fimp)
{
    if (fimp)
    {
...
gboolean read_OTG_playlists (FImport *fimp)
{
...
gboolean parse_fimp (FImport *fimp)
{
    glong seek=0;
    FContents *cts;
